...
$menu_seo = MySQL_Query("SELECT title, description, keywords FROM stranky7 WHERE str='".addslashes($p)."'");
    ...
    <main>
      ...
      <section class="hero">
        <div class="container">
          ...
          <?
          // text z db
          $query_text = MySQL_Query("SELECT * FROM stranky7 WHERE str='uvod' ") or die(err(1));
      ...
      <section class="contact">
		...
		if(!strstr($_SERVER['HTTP_USER_AGENT'],"W3C_Validator"))
          ...
          <?
		// text z db
		$query_text2 = MySQL_Query("SELECT * FROM stranky7 WHERE id=2 ") or die(err(1));
