...
{
$query_nastaveni = MySQL_Query("SELECT str,obsah FROM obecne_nastaveni7") or die(err(1));
...
{
$query_novinky = MySQL_Query("SELECT * FROM aktuality7 WHERE aktivni=1 AND lang='".__LANG__."' ORDER BY datum DESC, id DESC") or die(err(1));
...
{
  $query_pa = MySQL_Query("SELECT idp FROM zbozi7") or die(err(1));
