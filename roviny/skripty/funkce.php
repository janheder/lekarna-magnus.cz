...
{
$query_novinky = MySQL_Query("SELECT * FROM aktuality4 WHERE aktivni=1 AND lang='".__LANG__."' ORDER BY datum DESC, id DESC") or die(err(1));
...
{
  $query_pa = MySQL_Query("SELECT idp FROM zbozi4") or die(err(1));
