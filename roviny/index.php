...
$menu_seo = MySQL_Query("SELECT title, description, keywords FROM stranky4 WHERE str='".addslashes($p)."'");
...
<html lang="cs">
  <head>
    ...
    <link rel="canonical" href="https://lekarna-rovniny.cz/">
...
<script type="text/plain" data-cookiecategory="performance">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-40026181-3']);
    ...
    <header id="top">
      <div class="container">
        <div class="header-inner">
          <a href=""><img src="images/logo-roviny.png"></a>
          <nav>
    ...
    <main>
      ...
      <section class="hero">
        <div class="container">
          ...
          <?
          // text z db
          $query_text = MySQL_Query("SELECT * FROM stranky4 WHERE str='uvod' ") or die(err(1));
      ...
      <section class="contact">
		...
		if(!strstr($_SERVER['HTTP_USER_AGENT'],"W3C_Validator"))
            ...
            <img src="images/mapa-roviny.png">
    </div>

          <div class="otv_doba" id="kontakt">
          <?
		// text z db
		$query_text2 = MySQL_Query("SELECT * FROM stranky4 WHERE id=2 ") or die(err(1));
      ...
      <section class="other-pharmacies">
        <div class="container">
          ...
          <div class="other-logos">
              ...
              <?
		$query_partneri = MySQL_Query("SELECT * FROM odkazy4 WHERE id=1 ") or die(err(1));
		...
		?>
          ...
          <div class="pharmacies">
            ...
            <div class="pharmacies-wrap">
                ...
                <a href="https://www.lekarna-avion.cz"><img src="images/ico_rymarov.png" alt="Lékárna Rýmařov" title="Lékárna Rýmařov"></a>
