...
{
$query_nastaveni = MySQL_Query("SELECT str,obsah FROM obecne_nastaveni10") or die(err(1));
...
{
$query_novinky = MySQL_Query("SELECT * FROM aktuality10 WHERE aktivni=1 AND lang='".__LANG__."' ORDER BY datum DESC, id DESC") or die(err(1));
...
{
  $query_pa = MySQL_Query("SELECT idp FROM zbozi10") or die(err(1));
